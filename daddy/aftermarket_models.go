...
// AftermarketListingAction contains the resulting action ID from performing a change
// to the Aftermarket listings
type AftermarketListingAction struct {
	ListingActionID int
}

// AftermarketListingExpiryCreate handles the input structure for creating a new listing
